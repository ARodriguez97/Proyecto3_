...
/* Se muestra la fecha en curso.*/
  ...
  <p>
    <input name="aceptarCambio" class='button' type="button" id="aceptarCambio" value="Aceptar Cambio" onClick="javascript:enviar(true);">
    <input name="descartarCambio" class='button' type="button" id="descartarCambio" value="Descartar Cambio" onClick="javascript:enviar(false);">
</p>
</body>
</html>
