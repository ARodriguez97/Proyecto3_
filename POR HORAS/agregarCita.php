...
// Se muestra la fecha en curso.
    ...
    <form action="" method="post" name="formularioNuevaCita" id="formularioNuevaCita">
      ...
      <table width="500" height="44" border="0" cellpadding="0" cellspacing="0">
        <tr align="center">
          <td width="248"><input name="grabarCita"  class="button" type="button" id="grabarCita" value="Grabar la cita" onClick="javascript:mandar(true);"></td>
          <td width="252"><input name="anularCita"  class="button" type="button" id="anularCita" value="Cancelar" onClick="javascript:mandar(false);"></td>
        </tr>
      </table>
  </form>
  </body>
